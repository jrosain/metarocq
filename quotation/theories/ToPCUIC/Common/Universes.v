...
#[export] Instance quote_instance : ground_quotable Instance.t := ltac:(destruct 1; exact _).
#[export] Instance quote_uctx : ground_quotable UContext.t := ltac:(destruct 1; exact _).
...
#[export] Instance quote_leq_universe_n {cf n ϕ u u'} : ground_quotable (@leq_universe_n cf (uGraph.Z_of_bool n) ϕ u u') := ground_quotable_of_dec (@leq_universe_n_dec cf _ ϕ u u').
