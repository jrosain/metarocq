...
#[export] Instance quote_cumul_predicate {cumul Γ Rq Re p p'} {qcumul : quotation_of cumul} {qRq : quotation_of Rq} {qRe : quotation_of Re} {quote_cumul : forall x y Γ, ground_quotable (cumul Γ x y)} {quote_Rq : forall x y, ground_quotable (Rq x y:Prop)} {quote_Re : forall x y, ground_quotable (Re x y:Prop)} : ground_quotable (@cumul_predicate cumul Rq Re Γ p p')
...
Definition quote_cumul_predicate_via_dep {cumul Γ Rq Rq' Re Re' p p'} {c : @cumul_predicate cumul Rq Re Γ p p'} (qc : cumul_predicate_dep c (fun _ _ _ c => quotation_of c) Rq' Re') {qcumul : quotation_of cumul} {qRq : quotation_of Rq} {qRe : quotation_of Re} {quote_Rq : forall x y, ground_quotable (Rq x y:Prop)} {quote_Re : forall x y, ground_quotable (Re x y:Prop)} : quotation_of c.
Proof.
...
Proof.
  ...
  eapply quote_cumul_predicate_via_dep; eauto.
  all: intros; cbn; exact _.
Defined.
