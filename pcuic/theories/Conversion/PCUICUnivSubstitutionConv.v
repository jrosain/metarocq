...
Proof.
  unfold cmp_instance, subst_instance, on_rel.
...
Proof.
  ...
  - destruct X2 as [? [? [? ?]]].
    ...
    * destruct c. apply Forall2_All2. eapply Forall2_impl; eauto.
    * destruct c. apply Forall2_All2. eapply Forall2_impl; eauto.
      intros ???. unfold on_rel. unfold on_rel in H1. rewrite -!subst_instance_universe_make.
      solve_all.
