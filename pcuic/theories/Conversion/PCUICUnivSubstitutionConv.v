...
Proof.
  ...
  - eapply rel_subst_instance; eauto.
  - eapply rel_subst_instance; eauto.
  - eapply rel_subst_instance; eauto.
...
Proof.
  ...
  all: unfold subst_instance; cbv [subst_instance_decl]; cbn.
...
Proof.
  ...
  intros n x. destruct x. (* subst_instance_def is wrong!! *)
  rewrite /vass /subst_instance /subst_instance_decl /=. f_equal.
  - admit.
